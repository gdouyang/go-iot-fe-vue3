export default {
  ...
  agent: {
    notConfigured: 'Configure an AI model first',
    ...
    composerPlaceholder: 'Describe the product, thing model, or codec',
    ...
    resumeHint: 'Change applied. Continue with the thing model or codec.',
    emptyChat: 'Describe the onboarding need. The assistant will draft a product, TSL, and codec.',
    apply: 'Apply',
    reject: 'Reject',
    applied: 'Applied',
    rejected: 'Rejected',
    ...
    docTsl: 'Thing model',
    docScript: 'Codec',
    docConfig: 'Network config',
    viewTsl: 'View thing model',
    hideTsl: 'Hide thing model',
    viewScript: 'View codec',
    hideScript: 'Hide codec',
    viewConfig: 'View network config',
    hideConfig: 'Hide network config',
    previewOld: 'Current',
    previewNew: 'Incoming',
